          ...
          <div className="hidden md:flex items-center gap-8">
            {links.map((l) => (
              <button
                ...
                style={{
                  color: current === l.page ? "#C75D3A" : "rgb(212, 168, 83)",
                }}
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          {["home", "menu", "celebrations", "about", "gallery", "contact"].map(
            (p) => (
              <button
                key={p}
                onClick={() => go(p)}
...
function BowlIcon() {
  return (
    ...
    >
      ...
      <path d="M8 20h8" />
      <path d="M9 6c0-1 .8-1.4.8-2.2" />
      <path d="M14 6c0-1 .8-1.4.8-2.2" />
    </svg>
  )
}
...
function HandshakeIcon() {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="m8 12 3-3 2 2 3-3 4 4" />
      <path d="m2 12 4-4 5 5" />
      <path d="m7 13 3 3c1 1 2.4 1 3.4 0l4.6-4" />
      <path d="M3 17h4" />
      <path d="M17 17h4" />
    </svg>
  )
...
function TrophyIcon() {
  return (
    ...
    >
      ...
      <path d="M8 7H4a4 4 0 0 0 4 4" />
      <path d="M16 7h4a4 4 0 0 1-4 4" />
      <path d="M12 13v5" />
      <path d="M9 21h6" />
      <path d="M10 18h4" />
    </svg>
