          ...
          <div className="hidden md:flex items-center gap-8">
            {links.map(l => (
              <button
                ...
                style={{ color === l.page ? '#C75D3A' : '#3A241B' }}
              >
                {l.label}
              </button>
            ))}
...
function HomePage({ onNav }) {
  ...
  const trustCards = [
    ...
    { icon: '✨', title: 'Beautiful Presentation', desc: 'Your celebration deserves to look tastes. Every order is styled to impress.' },
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-base leading-relaxed mb-8" style={{ color: '#8B7A6F' }}>
              Every Puff Puff, every cake, every platter is made with the same care and love it were for our own family. Because to us, your celebration matters.
            </p>
          ...
          <div className="mt-12 space-y-3">
            {faqs.map((f, i) => (
              <div key={i} className="rounded-xl overflow-hidden border" style={{ borderColor: '#EDE7D9', backgroundColor: '#fff' }}>
                ...
                >
                  <span>{f.q}</span>
                  <span className="flex-shrink-0 text-lg transition-transform duration-200" style={{ transform === i ? 'rotate(45deg)' : 'none', color: '#C75D3A' }}>+</span>
                </button>
                {openFaq === i && (
...
// ─── MENU PAGE ────────────────────────────────────────────────────────────────
desc: string; price: string; img: string; cat: MenuCategory }[] = [
...
function AboutPage() {
  ...
  const timeline = [
    ...
    { year: '2020', event: 'Growing Demand', desc: 'Word spread quickly. Essie formalised Essie Chops business, taking orders from across London.' },
      ...
      <section className="px-6 mb-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-base leading-relaxed mb-4" style={{ color: '#5C3D2E' }}>
              Essie Chops was founded by Esther — a passionate baker whose love for Nigerian food and celebration runs roots. Growing up in a household where food was the language of love, Esther learned to cook authentic Nigerian recipes at her mother's side.
            </p>
...
// ─── GALLERY PAGE ─────────────────────────────────────────────────────────────
caption: string; cat: GalleryFilter }[] = [
