...
// ─── Types ────────────────────────────────────────────────────────────────────
type Page = "home" | "menu" | "celebrations" | "about" | "gallery" | "contact"
...
const IMGS = {
  ...
  cake1:
    "https://images.unsplash.com/photo-1617959587603-60cd216906c9?w=800&h=900&fit=crop&auto=format",
  cake2:
    "https://images.unsplash.com/photo-1758739012177-be3412cf865a?w=800&h=900&fit=crop&auto=format",
  platter:
    "https://images.unsplash.com/photo-1576842546422-60562b9242ae?w=800&h=600&fit=crop&auto=format",
  pastry:
    "https://images.unsplash.com/photo-1545668855-b923f0176935?w=800&h=600&fit=crop&auto=format",
  catering:
    "https://images.unsplash.com/photo-1651964060295-ef9e1ee08667?w=1200&h=700&fit=crop&auto=format",
  founder:
    "https://images.unsplash.com/photo-1709837167686-a2e33aad1bf0?w=700&h=900&fit=crop&auto=format",
  chef2:
    "https://images.unsplash.com/photo-1709837167684-47d7ccf0ed89?w=700&h=900&fit=crop&auto=format",
  puffpuff:
    "https://images.unsplash.com/photo-1725517561537-defd6a13b174?w=800&h=600&fit=crop&auto=format",
  dumplings:
    "https://images.unsplash.com/photo-1555244162-803834f70033?w=800&h=600&fit=crop&auto=format",
  bread:
    "https://images.unsplash.com/photo-1608039783021-6116a558f0c5?w=800&h=600&fit=crop&auto=format",
  pie: "https://images.unsplash.com/photo-1546024664-9226c2d3819b?w=800&h=600&fit=crop&auto=format",
  restaurant:
    "https://images.unsplash.com/photo-1779265298717-e3b21e7973e7?w=1200&h=700&fit=crop&auto=format",
  desserts:
    "https://images.unsplash.com/photo-1769812343628-81300c21753c?w=800&h=600&fit=crop&auto=format",
}
...
function SectionHeader({
  ...
  return (
    <div className={center ? "text-center max-w-2xl mx-auto" : "max-w-xl"}>
      ...
      {subtitle && (
        <p className="text-base leading-relaxed" style={{ color: "#8B7A6F" }}>
          {subtitle}
        </p>
      )}
    </div>
    ...
    <>
      <nav
        ...
        style={{
          ...
          boxShadow:
            !menuOpen && scrolled ? "0 1px 24px rgba(58,36,27,0.08)" : "none",
        }}
      >
          ...
          <div className="hidden md:flex items-center gap-8">
            {links.map((l) => (
              <button
                ...
                style={{ color: current === l.page ? "#C75D3A" : "#3A241B" }}
              >
                {l.label}
              </button>
            ))}
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center flex-1 gap-2 px-6 py-12">
          <img src={ecLogo} alt="Essie Chops" className="h-16 mb-8" />
          {links.map((l) => (
            <button
              key={l.page}
              onClick={() => go(l.page)}
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="md:col-span-1">
          <img
            src={ecLogo}
            alt="Essie Chops"
            className="h-14 mb-5 brightness-0 invert"
          />
          <p
        ...
        <div>
          ...
          >
            ...
            <p>📞 +44 (0)7700 000000</p>
            <p>✉️ hello@essiechops.co.uk</p>
            <p>🕐 Mon–Sat: 9am–7pm</p>
          </div>
          <a
            href={WHATSAPP}
...
// Mobile sticky bar
function StickyMobileBar({ onContact }: { onContact: () => void }) {
  return (
    <div
...
function HomePage({ onNav }: { onNav: (p: Page) => void }) {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      review:
        "Nothing beats authentic Nigerian food at a family occasion. Essie delivered exactly that — the meat pies were divine.",
      stars: 5,
    },
  ]
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, rgba(58,36,27,0.85) 0%, rgba(58,36,27,0.5) 60%, rgba(58,36,27,0.2) 100%)",
            }}
          />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-28 pb-20">
          <div className="max-w-xl">
            ...
            >
              Celebrations
              <br />
              <em className="font-normal" style={{ color: "#D4A853" }}>
                Taste Better
              </em>
              <br />
              with Essie Chops
            ...
            <p className="text-base md:text-lg text-white/80 mb-10 leading-relaxed max-w-md">
              ...
              comfort food — made fresh for your most meaningful moments.
            </p>
            ...
            {categories.map((c) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to top, rgba(58,36,27,0.9) 0%, rgba(58,36,27,0.1) 60%, transparent 100%)",
                  }}
                />
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p
              ...
              style={{ color: "#8B7A6F" }}
            >
              Every Puff Puff, every cake, every platter is made with the same
              care and love as if it were for our own family. Because to us,
      ...
      >
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-white/80 mb-10 leading-relaxed">
            Message us on WhatsApp to discuss your order. We'll respond quickly
...
// ─── MENU PAGE ────────────────────────────────────────────────────────────────
type MenuCategory = "All" | "Pastries" | "Comfort Food" | "Small Chops" | "Cakes" | "Platters"
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 text-center">
          ...
          <p
            ...
            style={{ color: "#8B7A6F" }}
          >
            Every item is freshly made to order. No shopping cart needed —
            simply enquire via WhatsApp and we'll handle everything.
          </p>
        </div>
        ...
        >
          ...
          >
            We offer bespoke orders — just ask. We love a creative challenge.
          </p>
          <BtnPrimary>
    ...
    >
      ...
      <div className="px-6 text-center mb-20">
        <div className="max-w-2xl mx-auto">
          ...
          >
            Every Occasion
            <br />
            <em className="font-normal" style={{ color: "#C75D3A" }}>
      ...
      >
        ...
        <div className="text-center mt-14">
          <BtnPrimary>
            <WhatsAppIcon /> Start Your Celebration
          </BtnPrimary>
        </div>
      </section>
    </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p
              ...
              style={{ color: "#8B7A6F" }}
            >
              When she moved to the UK, she realised something was missing at
              every celebration: the warmth, the flavour, and the authenticity
              of home. So she decided to bring it herself.
            </p>
            <p
              className="text-base leading-relaxed mb-8"
              style={{ color: "#8B7A6F" }}
            ...
            <div className="flex gap-4">
              <div className="text-center">
                ...
                <p className="text-xs" style={{ color: "#8B7A6F" }}>
                  Orders Fulfilled
                </p>
              </div>
              ...
              <div key={t.year} className="flex gap-8">
                <div className="flex flex-col items-center">
                  <div
                    ...
                    style={{ backgroundColor: "#D4A853", color: "#3A241B" }}
                  >
                    {t.year}
                  </div>
                  {i < timeline.length - 1 && (
...
// ─── GALLERY PAGE ─────────────────────────────────────────────────────────────
type GalleryFilter = "All" | "Cakes" | "Platters" | "Pastries" | "Catering" | "Events"

function GalleryPage() {
  const [filter, setFilter] = useState<GalleryFilter>("All")

  const images: { src: string caption: string cat: GalleryFilter }[] = [
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p
            ...
            style={{ color: "#8B7A6F" }}
          >
            Browse our portfolio of celebration cakes, platters, catering, and
          ...
          {filtered.map((img, i) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to top, rgba(58,36,27,0.8) 0%, transparent 60%)",
                }}
              >
...
function ContactPage() {
  ...
  const inputCls =
    "w-full px-4 py-3.5 rounded-xl text-sm border focus:outline-none focus:ring-2 transition-all"
  const inputStyle = {
    backgroundColor: "#fff",
    borderColor: "#EDE7D9",
    color: "#2B2522",
  ...
  return (
    ...
    >
      ...
      <div className="px-6 text-center mb-16">
        ...
        <h1
          className="text-5xl md:text-6xl font-semibold mb-4"
          style={{ fontFamily: "Cormorant Garamond, serif", color: "#3A241B" }}
        >
          Start Your Order
        </h1>
        <p className="text-base max-w-xl mx-auto" style={{ color: "#8B7A6F" }}>
          Ready to plan something special? Reach out via WhatsApp for the
          quickest response, or fill in the form below.
        </p>
      </div>
        ...
        >
          ...
          {sent ? (
            <div className="text-center py-12">
              ...
              <div className="mt-6">
                <BtnPrimary>
                  <WhatsAppIcon /> Also message us on WhatsApp
                </BtnPrimary>
              </div>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <BtnPrimary className="w-full justify-center" onClick={undefined}>
                Send Enquiry →
              </BtnPrimary>
            </form>
          )}
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-5 text-sm">
              {[
                { icon: "✉️", label: "Email", val: "hello@essiechops.co.uk" },
                {
                  icon: "📍",
                  label: "Based in",
